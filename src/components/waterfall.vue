<template>
  <div class="content">
    <GridContent :data-list="dataList" :columns="columns" :width="windowWidth" :height="windowHeight" :loading="isLoading"
      :line-px="10" :space="10" @getMoreData="getMoreData">
...
import { getRandomInitInclusive } from '../utils';
