<template>
	<div ref="gridContent" class="grid-content" :style="gridStyle" @scroll="getMoreData">
		<grid-item v-for="item in showDataList" :key="item.dataIndex" :data="item" :line-px="linePx">
			<template #slot-scope="slotProps">
				<slot name="slot-scope" :slot-props="slotProps"></slot>
			</template>
		</grid-item>
	</div>
</template>
